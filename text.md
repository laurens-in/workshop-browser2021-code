...
From this realization that the medium at least shapes the message, we can draw two conclusions for us as artists. 
...
2. If certain media allows us to express things that others don't, then we can also create new forms of art through new media/technologies. Again this is very obvious: Electronic music can only exist because we have devices that are capable of producing electronic sounds.
...
So what is the browser? The browser is an environment which executes code, namely HTML, CSS and JavaScript. If we look at the medium-message relationships of that system, it look something like this:
...
Important to me is especially the relationship between code and music. Not because the browser isn't an interesting environment, but because code is the foundation through which we compose music within that environment. The browser has a great importance in our life. Its the portal through which we access the internet, so much so that for a lot of people its synonymous with the internet. But the layers that the browser adds to our artworks are of political or social nature, not so much compositional. So if code is the medium through which our compositions come into existence, what separates code from any other medium?

The possibility to **generate** music in real-time instead of just playing it back. Of course, the browser is not the only medium that is able to generate music, but it does differ from other technology as we will see in the next chapter.
...
In his famous essay "The Work of Art in the Age of Mechanical Reproduction" (1935) Walter Benjamin talks about the transition art undergoes by entering media which is mechanically reproducible. One essential part of this process is that the artwork looses its aura:
...
Through reproduction art now becomes available to the masses. This is important for Benjamin from a Marxist point of view:
----Think about the invention of printing and what it meant for people being able to read the bible.[^printing-bible] Benjamin gives us a hint at what he's going at:
...
I would argue that we are now not only in the age of the digital reproduction of art[^digital-art], but go even further: the age of the digital **generation** of art. While of course the digital reproduction was a significant step, it is outweighed by the conceptual difference between reproduction and generation in general.

But how do we conceptualize generative art?

For me it's the idea of an abstract piece of art which exists only through its specific instantiation, which is unique in time and space. These ideas aren't really new though, they have existed in art for quite some time. Not in the dodecaphonic music of Schönberg and his followers, not in the serialism of Messiaen or the algorithmic composition of Hiller & Issacson. We find it first in early performance art, for example the sound-walks of Max Neuhaus: The composition exists in the form of a route which the composer knows and walks with his audience. Within that route the sounds are certainly predictable, but ultimately - from a compositional perspective - random. In addition to that the performance could only be "reproduced" (in a way that it loses its uniqueness) by means of preservation - a recording, a film - or by means of reenactment - essentially theater - by both of which it is no longer performance art as a result.

Generative music on the other - up until now - exists almost exclusively in an exhibition space. This means I have the go to the museum, sit on an uncomfortable chair or bench and listen to the generative piece for about 10 minutes with people walking in and out only conceptually being able to grasp the extent of the composition, then going home, mostly disappointed. What good is an endless composition if I can only listen to it one time?

So why are we in a new age now? Not when the firs generative compositions started playing in exhibitions or concerts? Why draw the line here?
...
This quote by artist and developer behind [generative.fm](https://generative.fm) Alex Bainter explains what has changed: for the first time generative art has the possibility move into mass culture. It has that possibility because with the browser, we now have an environment which allows artists to produce and distribute real-time systems relatively easily.

So what does this mean for art? How does it affect the aura, authority and authenticity of the work of art?
...
The last thing I want to talk about concerning this subject is authority, and for this we need a different perspective.



## Part 3 - Adorno & Schaeffer

We have established that the browser is an interesting medium that we can use to create new forms of music, I then argued that this form should be a generative form and given some thoughts about the paradigm change this could mean for the work of art in the age of its digital generatability.
